    ...
    public partial class MembershipTable : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerMovies", x => new { x.CustomersId, x.MoviesId });
                    table.ForeignKey(
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerMovies_Movies_MoviesId",
                        column: x => x.MoviesId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationInMonth = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CustomerMovies_MoviesId",
